...
*   File Name: renderLetters.h
*   File Description: renderLetters implments graphics for drawing
*   the font
...
private:
    ...
    *   pre-condition: a rendering object exists
    *   post-condition: a character has been drawn to the screen
    *   return: void
    */
